...
const todaySchedule = null; // e.g. { time: '8:00 AM - 12:00 PM', office: 'Library' }
                ...
                <View style={styles.header}>
                    <View style={styles.headerBadgeRow}>
                        <View style={styles.statusPill}>
                            ...
                            <Text style={styles.statusPillText}>Active Assistant · 2026</Text>
                        </View>
                        ...
                        <View style={styles.quickActionsRow}>
                            ...
                            >
                                ...
                                <View style={{ flex: 1 }}>
                                    ...
                                    <Text style={styles.quickActionSub}>View calendar & shifts</Text>
                                </View>
                            ...
                            >
                                ...
                                <View style={{ flex: 1 }}>
                                    ...
                                    <Text style={styles.quickActionSub}>Account & credentials</Text>
                                </View>
                                <ChevronRight size={16} color="#94a3b8" />
                            </TouchableOpacity>
                        </View>
