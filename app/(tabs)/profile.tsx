        ...
        setStudent((current) => ({
          ...
          yearLevel:
            data.student.year_level === null
              ? "Not provided"
              : `${data.student.year_level}th Year`,
          dateJoined: data.student.date_joined,
          office: data.assignment.office ?? "Unassigned",
          applicationStatus: data.assignment.status,
          hoursPerWeek: data.assignment.hours_per_week,
          skills: data.assignment.skills,
            ...
            <View style={styles.body}>
              ...
              <View style={styles.avatarCard}>
                ...
                <View style={styles.avatarStatsRow}>
                  ...
                  <View
                    style={[styles.avatarStat, { backgroundColor: "#fffbeb" }]}
                  >
                    <Text
                      style={[styles.avatarStatValue, { color: "#a16207" }]}
                    >
                      {student.acceptedDuties}
                    </Text>
              ...
              <View
                ...
                onLayout={(e) => {
                  personalInfoY.current = e.nativeEvent.layout.y;
                }}
              >
              ...
              <View style={styles.infoCard}>
                ...
                <View style={styles.field}>
                  ...
                  <Text style={styles.fieldHint}>
                    Based on your latest application and current schedule
                  </Text>
                </View>
                <View style={styles.field}>
                  ...
                  <Text style={styles.fieldHint}>
                    Reviewed by the student affairs team
                  </Text>
                </View>
                ...
                <Text style={styles.qualNote}>
                  Profile changes stay under admin oversight. If your skills or
                  assignment details are outdated, ask the SDAO office to review
                  your record.
                </Text>
              </View>
                ...
                <View style={styles.perfStatsRow}>
                  <View style={styles.perfStat}>
                    <Text style={styles.perfStatValue}>
                      {student.totalDutyHours.toFixed(1)} hrs
                    </Text>
