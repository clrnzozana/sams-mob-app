...
export default function ScheduleScreen() {
    ...
    const pendingCount = useMemo(() => {
        return schedule.filter((s) => s.status === 'pending').length;
    }, [schedule]);
    ...
    const handleRespond = (id: number, newStatus: 'accepted' | 'declined') => {
        setSchedule((prev) =>
            ...
            <View style={styles.header}>
                <View style={styles.headerTop}>
                    <View style={{ flex: 1, paddingRight: 12 }}>
                        ...
                        <Text style={styles.headerSub}>Manage your weekly duty assignments</Text>
                    </View>
                ...
                <View style={styles.viewSwitcher}>
                    <TouchableOpacity
                        style={[styles.switchBtn, view === 'calendar' && styles.switchBtnActive]}
                        onPress={() => setView('calendar')}
                        activeOpacity={0.8}
                    >
                        <CalendarIcon
                            size={14}
                            color={view === 'calendar' ? '#003087' : 'rgba(255,255,255,0.85)'}
                        />
                        <Text
                            style={[
                                styles.switchText,
                ...
                <View style={styles.statsRow}>
                    <View style={styles.statBox}>
                        ...
                        <View style={styles.statInfo}>
                            <Text style={styles.statVal}>{totalWeeklyHours.toFixed(1)}h</Text>
                    ...
                    <View style={[styles.statBox, pendingCount > 0 && styles.statBoxHighlight]}>
                        <View
                            style={[
                                styles.statIconWrap,
                ...
                {view === 'calendar' ? (
                    <View style={styles.sectionWrap}>
                        <View style={styles.sectionHeader}>
                            ...
                            <Text style={styles.sectionHelper}>Tap any block to view details</Text>
                        </View>
                            ...
                            >
                                <View>
                                    ...
                                    <View style={styles.calHeaderRow}>
                                        <View style={[styles.calHeaderTimeCell, { width: TIME_COL_W }]}>
                                            <Text style={styles.calHeaderTimeText}>TIME</Text>
                                        </View>
                                        {DAYS.map((day, i) => (
                                            <View
                                                key={day}
                                                style={[styles.calHeaderDayCell, { width: DAY_COL_W }]}
                                            >
                    ...
                    <View style={styles.sectionWrap}>
                        ...
                        >
                            {(['all', 'pending', 'accepted', 'deployed', 'declined'] as const).map(
                                (tab) => {
                                            ...
                                            <View>
                                                ...
                                                <View style={styles.listTimeWrap}>
                                                    ...
                                                    <Text style={styles.listTimeText}>
                                                        {item.timeStartLabel} – {item.timeEndLabel} ({item.hours} hrs)
                                                    </Text>
                                                </View>
                                            </View>
                                            <View
                        ...
                        <Pressable style={styles.modalCard} onPress={(e) => e.stopPropagation()}>
                            <View style={styles.modalHeader}>
                                <View style={{ flex: 1 }}>
                                    <Text style={styles.modalDay}>
                                        {selectedEntry.fullDate ?? `${selectedEntry.day}, ${selectedEntry.date}`}
                                    </Text>
                                    <Text style={styles.modalTime}>
                                        {selectedEntry.timeStartLabel} – {selectedEntry.timeEndLabel} ({selectedEntry.hours} hrs)
                                    </Text>
                                </View>
                                <TouchableOpacity
                                    onPress={() => setSelectedEntry(null)}
                            ...
                            <View style={styles.modalBody}>
                                <View style={styles.modalRow}>
                                    ...
                                    <View style={{ marginLeft: 10, flex: 1 }}>
                                        ...
                                        <Text style={styles.modalValue}>{selectedEntry.office}</Text>
                                    </View>
                                </View>
                                ...
                                {selectedEntry.supervisor && (
                                    <View style={styles.modalRow}>
                                        ...
                                        <View style={{ marginLeft: 10, flex: 1 }}>
                                            <Text style={styles.modalLabel}>Supervisor / Contact</Text>
                                            <Text style={styles.modalValue}>{selectedEntry.supervisor}</Text>
                                        </View>
                                    </View>
                                )}
                                ...
                                <View style={styles.modalStatusBox}>
                                    ...
                                    <View
                                        style={[
                                            styles.statusBadge,
                                            {
                                                backgroundColor: statusMeta[selectedEntry.status].bg,
                                                borderColor: statusMeta[selectedEntry.status].border,
                                                marginTop: 6,
                            ...
                            {selectedEntry.status === 'pending' ? (
                                <View style={styles.modalActionRow}>
                                    <TouchableOpacity
                                        style={[styles.btnAction, styles.btnAccept]}
                                        onPress={() => handleRespond(selectedEntry.id, 'accepted')}
                                        activeOpacity={0.8}
                                    >
                                    ...
                                    <TouchableOpacity
                                        style={[styles.btnAction, styles.btnDecline]}
                                        onPress={() => handleRespond(selectedEntry.id, 'declined')}
                                        activeOpacity={0.8}
                                    >
