...
export default function AttendanceScreen() {
  ...
  const summary = useMemo(() => {
    const renderedHours = logs.reduce((sum, l) => sum + l.hours, 0);
            ...
            <View style={styles.creativeGrid}>
              ...
              <View style={[styles.gridCard, styles.presentCard]}>
                <View style={styles.cardHeaderRow}>
                  ...
                  <View
                    style={[styles.tagPill, { backgroundColor: "#dcfce7" }]}
                  >
              ...
              <View style={[styles.gridCard, styles.lateCard]}>
                <View style={styles.cardHeaderRow}>
                  ...
                  <View
                    style={[styles.tagPill, { backgroundColor: "#fef3c7" }]}
                  >
              ...
              <View style={[styles.gridCard, styles.absentCard]}>
                <View style={styles.cardHeaderRow}>
                  ...
                  <View
                    style={[styles.tagPill, { backgroundColor: "#fee2e2" }]}
                  >
            ...
            >
              {(
                ...
                const count =
                  tab === "all"
                    ? logs.length
                    : logs.filter((l) => l.status === tab).length;
                  ...
                  <View key={log.id} style={styles.logCard}>
                    <View style={styles.logTopRow}>
                      <View>
                        ...
                        {log.office && (
                          <Text style={styles.logOfficeText}>{log.office}</Text>
                        )}
                      </View>
                      <View
                        style={[
                      ...
                      >
                        ...
                        />
                        <Text
                          style={[styles.statusBadgeText, { color: meta.text }]}
                        >
                          {meta.label}
                        </Text>
                      </View>
